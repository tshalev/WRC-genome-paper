...
all_snp_ids <- read.table("all_snp_ids.txt")
...
FS_lines_allele_matrix <- t(read.csv("FS_lines_alleles.csv", check.names = F))
S1_lines_allele_matrix <- t(read.csv("S1_lines_alleles.csv", check.names = F))
S2_lines_allele_matrix <- t(read.csv("S2_lines_alleles.csv", check.names = F))
S3_lines_allele_matrix <- t(read.csv("S3_lines_alleles.csv", check.names = F))
S4_lines_allele_matrix <- t(read.csv("S4_lines_alleles.csv", check.names = F))
S5_lines_allele_matrix <- t(read.csv("S5_lines_alleles.csv", check.names = F))
...
wilcox.test(S2$Observed, S2$Expected, paired = T, alternative = "less")
...
wilcox.test(S3$Observed, S3$Expected, paired = T, alternative = "less")
...
wilcox.test(S4$Observed, S4$Expected, paired = T, alternative = "less")
...
wilcox.test(S5$Observed, S5$Expected, paired = T, alternative = "greater")
...
RWP_vcf <- read.vcfR("RWP_all_snps.vcf")
