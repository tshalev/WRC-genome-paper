...
Line_1_1_corrected <- read.table("corrected_full_lines_noparents/Line_1_1_corrected_manually.txt", check.names = F)
# Line_1_4_corrected <- read.table("corrected_full_lines_noparents/Line_1_4_corrected_manually.txt", check.names = F)
...
Line_1_4_het_S4 <- Line_1_4_corrected %>% rownames_to_column() %>% 
  filter(`145-545-S4` == 1) %>% column_to_rownames()

##Line 6#################################################################################################################
Line_6_1_corrected <- read.table("corrected_full_lines_noparents/Line_6_1_corrected_manually.txt", check.names = F)
Line_6_4_corrected <- read.table("corrected_full_lines_noparents/Line_6_4_corrected_manually.txt", check.names = F)
...
Line_7_2_corrected <- read.table("corrected_full_lines_noparents/Line_7_2_corrected_manually.txt", check.names = F)
Line_7_4_corrected <- read.table("corrected_full_lines_noparents/Line_7_4_corrected_manually.txt", check.names = F)
...
#Line 8##################################################################################################################
Line_8_2_corrected <- read.table("corrected_full_lines_noparents/Line_8_2_corrected_manually.txt", check.names = F)
Line_8_4_corrected <- read.table("corrected_full_lines_noparents/Line_8_4_corrected_manually.txt", check.names = F)
...
Line_10_2_corrected <- read.table("corrected_full_lines_noparents/Line_10_2_corrected_manually.txt", check.names = F)
Line_10_5_corrected <- read.table("corrected_full_lines_noparents/Line_10_5_corrected_manually.txt", check.names = F)
...
Line_13_3_corrected <- read.table("corrected_full_lines_noparents/Line_13_3_corrected_manually.txt", check.names = F)
Line_13_4_corrected <- read.table("corrected_full_lines_noparents/Line_13_4_corrected_manually.txt", check.names = F)
...
Line_16_1_corrected <- read.table("corrected_full_lines_noparents/Line_16_1_corrected_manually.txt", check.names = F)
Line_16_5_corrected <- read.table("corrected_full_lines_noparents/Line_16_5_corrected_manually.txt", check.names = F)
...
Line_17_2_corrected <- read.table("corrected_full_lines_noparents/Line_17_2_corrected_manually.txt", check.names = F)
Line_17_5_corrected <- read.table("corrected_full_lines_noparents/Line_17_5_corrected_manually.txt", check.names = F)
...
Line_19_2_corrected <- read.table("corrected_full_lines_noparents/Line_19_2_corrected_manually.txt", check.names = F)
Line_19_5_corrected <- read.table("corrected_full_lines_noparents/Line_19_5_corrected_manually.txt", check.names = F)
...
Line_20_1_corrected <- read.table("corrected_full_lines_noparents/Line_20_1_corrected_manually.txt", check.names = F)
Line_20_4_corrected <- read.table("corrected_full_lines_noparents/Line_20_4_corrected_manually.txt", check.names = F)
...
Line_21_2_corrected <- read.table("corrected_full_lines_noparents/Line_21_2_corrected_manually.txt", check.names = F)
Line_21_6_corrected <- read.table("corrected_full_lines_noparents/Line_21_6_corrected_manually.txt", check.names = F)
...
Line_23_2_corrected <- read.table("corrected_full_lines_noparents/Line_23_2_corrected_manually.txt", check.names = F)
Line_23_4_corrected <- read.table("corrected_full_lines_noparents/Line_23_4_corrected_manually.txt", check.names = F)
...
Line_26_1_corrected <- read.table("corrected_full_lines_noparents/Line_26_1_corrected_manually.txt", check.names = F)
Line_26_4_corrected <- read.table("corrected_full_lines_noparents/Line_26_4_corrected_manually.txt", check.names = F)
...
Line_27_2_corrected <- read.table("corrected_full_lines_noparents/Line_27_2_corrected_manually.txt", check.names = F)

Line_27_2_het_F <- Line_27_2_corrected %>% rownames_to_column() %>% 
  filter(`27_2-F` == 1) %>% column_to_rownames()

Line_27_6_het_S4 <- Line_27_6_corrected %>% rownames_to_column() %>% 
  filter(`2765-554-S4` == 1) %>% column_to_rownames()

#Line 29##################################################################################################################

Line_29_2_corrected <- read.table("corrected_full_lines_noparents/Line_29_2_corrected_manually.txt", check.names = F)
Line_29_4_corrected <- read.table("corrected_full_lines_noparents/Line_29_4_corrected_manually.txt", check.names = F)
...
fixation_plots
# ggsave("fixation_plots.svg", fixation_plots, width = 16, height = 8)
#Heterozygosity plots across lines##########################################################################################################################
# het_all_lines <- read.table("../new_analysis/corrected_full_lines_noparents/corrected_lines_for_het_plot.txt", header = T, sep = "\t")
# het_all_lines$Parental_Line <- factor(het_all_lines$Parental_Line)
# 
# het_all_lines_corrected <- het_all_lines %>% 
#   filter(correction == "corrected")
# 
# het_all_lines_uncorrected <- het_all_lines %>% 
#   filter(correction == "uncorrected")
# 
# het_line_1_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 1)
# 
# het_line_6_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 6)
# 
# het_line_7_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 7)
# 
# het_line_8_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 8)
# 
# het_line_10_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 10)
# 
# het_line_13_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 13)
# 
# het_line_16_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 16)
# 
# het_line_17_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 17)
# 
# het_line_19_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 19)
# 
# het_line_20_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 20)
# 
# het_line_21_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 21)
# 
# het_line_23_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 23)
# 
# het_line_26_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 26)
# 
# het_line_27_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 27)
# 
# het_line_29_corrected <- het_all_lines_corrected %>% 
#   filter(Parental_Line == 29)
# 
# (corrected_het_plot <- ggplot(het_all_lines_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication())
# 
# 
# (uncorrected_het_plot <- ggplot(het_all_lines_uncorrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication())
# 
# ggsave("heterozygosity_plot_dated.png", uncorrected_het_plot, height = 5, width = 10)
# 
# ggplot(het_line_1_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_6_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_7_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_8_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_10_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_13_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_16_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_17_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_19_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_20_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_21_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_23_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_26_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_27_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_line_29_corrected, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_all_lines, aes(x = Generation, y = prop_het, colour = Parental_Line, group = FS_line)) +
#   geom_point(size = 3) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()
# 
# ggplot(het_all_lines, aes(x = Generation, y = prop_het, colour = FS_line, group = FS_line)) +
#   geom_point(size = 3, aes(shape = correction)) +
#   scale_y_continuous(name = "Heterozygsity", breaks = c(0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
#                                                         0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85), limits = c(0, 0.85)) +
#   geom_line() +
#   theme_Publication()

###Allelele Frequencies ######################################################################################
Propfunc <- function(x, dim = "row"){
  return((2*(rowSums(x == 2, na.rm = T)) + rowSums(x == 1, na.rm = T))/(2*(rowSums(!is.na(x)))))
}
...
S5_lines <- merge(S5_lines, S5_21_6_with_snp_names, by = "rowname", all = T)
# S5_lines <- merge(S5_lines, S5_23_2_with_snp_names, by = "rowname", all = T)
# S5_lines <- merge(S5_lines, S5_23_4_with_snp_names, by = "rowname", all = T)
S5_lines <- merge(S5_lines, S5_29_2_with_snp_names, by = "rowname", all = T)
S5_lines <- merge(S5_lines, S5_29_4_with_snp_names, by = "rowname", all = T)
...
# write.table(ref_fixed_overlap_table, "ref_fixed_overlap_table_no_23.txt", quote = F)
...
ref_fixed_overlap_select_table <- data.frame(table(sort(c(gt_1_1_fixed_ref$SNP, gt_6_1_fixed_ref$SNP, gt_8_2_fixed_ref$SNP, 
                                                          gt_16_1_fixed_ref$SNP, gt_17_2_fixed_ref$SNP, gt_20_1_fixed_ref$SNP,
                                                          gt_21_2_fixed_ref$SNP, gt_29_2_fixed_ref$SNP))))

ref_fixed_overlap_random_table <- data.frame(table(sort(c(gt_6_4_fixed_ref$SNP, gt_7_4_fixed_ref$SNP, gt_8_4_fixed_ref$SNP, 
                                                          gt_13_4_fixed_ref$SNP, gt_17_5_fixed_ref$SNP, gt_19_5_fixed_ref$SNP, 
                                                          gt_20_4_fixed_ref$SNP, gt_21_6_fixed_ref$SNP, gt_26_4_fixed_ref$SNP,
                                                          gt_29_4_fixed_ref$SNP))))
...
# write.table(alt_fixed_overlap_table, "alt_fixed_overlap_table_no_23.txt", quote = F)
...
alt_fixed_overlap_select_table <- data.frame(table(sort(c(gt_1_1_fixed_alt$SNP, gt_6_1_fixed_alt$SNP, gt_8_2_fixed_alt$SNP, 
                                                          gt_16_1_fixed_alt$SNP, gt_17_2_fixed_alt$SNP, gt_20_1_fixed_alt$SNP,
                                                          gt_21_2_fixed_alt$SNP, gt_29_2_fixed_alt$SNP))))

alt_fixed_overlap_random_table <- data.frame(table(sort(c(gt_6_4_fixed_alt$SNP, gt_7_4_fixed_alt$SNP, gt_8_4_fixed_alt$SNP, 
                                                          gt_13_4_fixed_alt$SNP, gt_17_5_fixed_alt$SNP, gt_19_5_fixed_alt$SNP, 
                                                          gt_20_4_fixed_alt$SNP, gt_21_6_fixed_alt$SNP, gt_26_4_fixed_alt$SNP,
                                                          gt_29_4_fixed_alt$SNP))))
...
# write.table(not_fixed_overlap_table, "not_fixed_overlap_table_no_23.txt", quote = F)
...
not_fixed_overlap_select_table <- data.frame(table(sort(c(gt_1_1_not_fixed$SNP, gt_6_1_not_fixed$SNP, gt_8_2_not_fixed$SNP, 
                                                          gt_16_1_not_fixed$SNP, gt_17_2_not_fixed$SNP, gt_20_1_not_fixed$SNP,
                                                          gt_21_2_not_fixed$SNP, gt_29_2_not_fixed$SNP))))

not_fixed_overlap_random_table <- data.frame(table(sort(c(gt_6_4_not_fixed$SNP, gt_7_4_not_fixed$SNP, gt_8_4_not_fixed$SNP, 
                                                          gt_13_4_not_fixed$SNP, gt_17_5_not_fixed$SNP, gt_19_5_not_fixed$SNP, 
                                                          gt_20_4_not_fixed$SNP, gt_21_6_not_fixed$SNP, gt_26_4_not_fixed$SNP,
                                                          gt_29_4_not_fixed$SNP))))
...
# write.table(S4_fate_table_props, "S4_fate_table.txt", row.names = F, col.names = T, quote = F)
...
write.table(S4_fate_table_props_for_chisq, "S4_fate_table_chisq_analysis_without_23.txt", row.names = F, col.names = T, quote = F)

# Significant results
S4_fate_table_significant <- S4_fate_table_props_for_chisq %>% 
  filter(p.adj.holm < 1e-05)

write.table(S4_fate_table_significant, "S4_fate_table_significant.txt", row.names = F, col.names = T, quote = F)

S4_fate_stop_gained <- S4_fate_table_significant %>% 
  filter()

# Do chi-squared for fixed vs. not fixed
S4_fate_table_props_for_chisq_fixed_vs_not_fixed <- S4_fate_table %>%
  mutate(fixed = ref_fixed + alt_fixed) %>% 
  select(SNP, not_fixed, fixed) %>% 
  mutate(total = not_fixed + fixed) %>% 
  mutate(not_fixed_exp = 0.0625 * total, fixed_exp = 0.9375 * total) %>%
  mutate(chi_sq = (((not_fixed - not_fixed_exp)^2/not_fixed_exp) + ((fixed - fixed_exp)^2/fixed_exp))) %>%
  mutate(p.value = pchisq(chi_sq, 1, lower.tail = F)) %>%
  mutate(p.adj.BH = p.adjust(p.value, "BH"), p.adj.bonf = p.adjust(p.value, "bonferroni"), p.adj.holm = p.adjust(p.value, "holm")) #%>% 
# filter(total >= 10)

S4_fate_table_props_for_chisq_fixed_vs_not_fixed_significant <- S4_fate_table_props_for_chisq_fixed_vs_not_fixed %>% 
  filter(p.adj.holm < 1e-05)

# Do chi-squared for fixed ref vs. fixed alt
S4_fate_table_props_for_chisq_ref_fixed_vs_alt_fixed <- S4_fate_table %>%
  mutate(total = (not_fixed + ref_fixed + alt_fixed)) %>% 
  select(SNP, ref_fixed, alt_fixed, total) %>% 
  mutate(ref_fixed_exp = 0.46875 * total, alt_fixed_exp = 0.46875 * total) %>%
  mutate(chi_sq = (((ref_fixed - ref_fixed_exp)^2/ref_fixed_exp) + ((alt_fixed - alt_fixed_exp)^2/alt_fixed_exp))) %>%
  mutate(p.value = pchisq(chi_sq, 1, lower.tail = F)) %>%
  mutate(p.adj.BH = p.adjust(p.value, "BH"), p.adj.bonf = p.adjust(p.value, "bonferroni"),  p.adj.holm = p.adjust(p.value, "holm"))# %>% 
# filter(total >= 10)

S4_fate_table_props_for_chisq_ref_fixed_vs_alt_fixed_significant <- S4_fate_table_props_for_chisq_ref_fixed_vs_alt_fixed %>% 
  filter(p.adj.holm < 0.05)
